  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        sm: "0 1px 3px 0 rgb(15 23 42 / 0.08), 0 1px 2px -1px rgb(15 23 42 / 0.05)",
        ...
        xl: "0 20px 25px -5px rgb(15 23 42 / 0.12), 0 8px 10px -6px rgb(15 23 42 / 0.05)",
        "2xl": "0 25px 50px -12px rgb(15 23 42 / 0.25)",
        glow: "0 0 24px rgb(2 132 199 / 0.25)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
